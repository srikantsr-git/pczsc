            ...
            <div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white shadow-2xl border border-slate-800 space-y-8 overflow-hidden animate-fade-in">
              {isEditMode && (
                <div className="absolute top-6 right-6 z-20">
                  ...
                  >
                    <Edit className="w-3.5 h-3.5" />
                    <span>Edit President's Message</span>
                  </button>
                </div>
              )}

              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-santic-red flex items-center justify-center text-white shadow-lg shadow-red-600/30">
                  <Award className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs font-bold uppercase tracking-widest text-santic-red block">
                    {aboutUsConfig.presidentSubtitle}
                  </span>
